...
const Create = () => {
  ...
  const submit = async () => {
    ...
    try {
      ...
      Alert.alert("Succes", "Posts uploaded succes");
      router.push("/home");
    } catch (error) {
  ...
  return (
    <SafeAreaView className="bg-primary h-full">
      <ScrollView className="px-4 my-6">
        ...
        <FormField title="Video Title" value={form.title} placeholder={"Give your a catch  title..."} handleChangeText={(e) => setForm({ ...form, title: e })} otherStyles={"mt-10"} />
