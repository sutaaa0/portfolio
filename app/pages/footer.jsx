...
const Footer = () => {
  return (
    <div id="contact" className="w-full flex justify-center items-center">
      <div className="sm:w-[60%] w-full sm:px-0  px-12 sm:h-[50%] flex flex-col justify-cneter items-center">
        ...
        <div className="flex w-full sm:justify-start justify-between  items-center mb-12">
